   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="gmap_marker_type2_area" style="<?php if($options['qt_gmap_marker_type'] == 'type1'){ echo 'display:none;'; } else { echo 'display:block;'; }; ?>">
      ...
      <p><input type="text" class="c-color-picker" name="dp_options[qt_gmap_marker_bg]" data-default-color="#000000" value="<?php echo esc_attr( $options['qt_gmap_marker_bg'] ); ?>"></p>
     </div>
