...
$layout_options = array(
 ...
 'type1' => array('value' => 'type1','label' => __( 'Display on right side', 'tcd-w' )),
 'type2' => array('value' => 'type2','label' => __( 'Display on left side', 'tcd-w' )),
 'type3' => array('value' => 'type3','label' => __( 'Don\'t display', 'tcd-w' ))
);
...
$content_width_options = array(
  'type1' => array('value' => 'type1','label' => '1200px'),
