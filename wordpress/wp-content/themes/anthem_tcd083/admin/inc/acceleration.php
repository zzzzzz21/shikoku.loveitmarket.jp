	...
	<div class="theme_option_field cf theme_option_field_ac open active">
		...
		<div class="theme_option_field_ac_content">
			...
			<div class="theme_option_message2">
				...
				<p><?php _e('Please note that if the server library (LIBXML) version is old, it will not work properly.', 'tcd-w');  ?></p>
			</div>
			<p><label><input name="dp_options[use_lazyload]" type="checkbox" value="1" <?php checked( 1, $dp_options['use_lazyload'] ); ?>> <?php _e( 'Use lazyload', 'tcd-w' ); ?></label></p>
