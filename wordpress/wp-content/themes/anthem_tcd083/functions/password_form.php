...
function tcd_password_form() {
  ...
  $output .= '<div class="c-pw__box">';
	...
	if ( ! $pw_content ) {
		...
		$output .= '<div><label class="c-pw__box-label" for="' . $label . '">' . __( 'Password:', 'tcd-w' ) . '</label><input class="c-pw__box-input" name="post_password" id="' . $label . '" type="password" size="20"><input class="c-pw__btn c-pw__btn--submit" type="submit" name="Submit" value="' . esc_attr_x( __('Send', 'tcd-w'), 'post password form' ) . '"></div></div></form>';
