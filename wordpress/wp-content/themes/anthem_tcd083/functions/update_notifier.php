...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_anthem.xml';
    $db_cache_field = 'anthem-contempo-notifier-cache';
    $db_cache_field_last_updated = 'anthem-contempo-notifier-last-updated';
