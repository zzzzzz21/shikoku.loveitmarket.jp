...
?>
			<li class="default feedly_button">
				<a href='https://feedly.com/index.html#subscription/feed/<?php bloginfo('rss2_url'); ?>'<?php echo ( is_mobile() ) ? '' : ' target="_blank"'; ?>><img id='feedlyFollow' src='//s3.feedly.com/img/follows/feedly-follow-rectangle-flat-small_2x.png' alt='follow us in feedly' width='66' height='20'></a>
			</li>
<?php 
		endif; 
